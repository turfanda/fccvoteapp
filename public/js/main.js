  ...
  $.ajax({
            ...
            success:function(data){
              ...
              $.each(polls,function(index,item){
                ...
                var ss=$("<a>").addClass("btn btn-info shareResult").text("Share Result").attr({href:"https://twitter.com/share","data-url":" https://fcc-vote-app.glitch.me/show"+item.pollName});
